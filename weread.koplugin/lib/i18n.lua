...
local zh = {
    ...
    ["Sync current book progress"] = "同步当前书籍进度",
    ["Syncing current progress to WeRead..."] = "正在同步当前进度到微信读书……",
    ["Progress uploaded to WeRead: %1% (offset %2)"] = "已上传进度到微信读书：%1%（偏移 %2）",
    ["Sync reading progress"] = "同步阅读进度",
    ["Fetching latest WeRead progress..."] = "正在获取微信读书最新进度……",
    ["Remote progress is empty."] = "远端进度为空。",
    ["Could not fetch remote progress."] = "无法获取远端进度。",
    ["Fastest download"] = "极速下载",
    ["text only, max concurrency"] = "仅正文，最大并发",
    ["Fastest download will skip images, underlines and thoughts and use the highest concurrency (%1). Continue?"] = "极速下载将跳过图片、划线和想法，并使用最高并发（共 %1 章）。是否继续？",
    ["Download all %1 chapters as one EPUB (fastest)?"] = "将 %1 章合并下载为一个 EPUB（极速）？",
    ...
    ["Prev"] = "上一页",
    ["Next"] = "下一页",
    ["This is the first chapter."] = "这已经是第一章了。",
    ["Page %1 / %2"] = "第 %1 / %2 页",
    ["Close book"] = "关闭书籍",
